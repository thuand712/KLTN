...
public class SanPhamYeuThichTabTaiKhoanAdapter extends RecyclerView.Adapter<SanPhamYeuThichTabTaiKhoanAdapter.ViewHolder> {

    Context context;
    ArrayList<SanPham>sanPhams;
    int layoutManager;

    public SanPhamYeuThichTabTaiKhoanAdapter(Context context, int layoutManager, ArrayList<SanPham> sanPhams) {
    ...
    @NonNull
    @Override
    public SanPhamYeuThichTabTaiKhoanAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
        if(layoutManager == 1){
            view = LayoutInflater.from(context).inflate(R.layout.dong_sanpham_yeuthich_tab_taikhoan, parent, false);
        }else {
    ...
    @Override
    public void onBindViewHolder(@NonNull SanPhamYeuThichTabTaiKhoanAdapter.ViewHolder holder, int position) {
