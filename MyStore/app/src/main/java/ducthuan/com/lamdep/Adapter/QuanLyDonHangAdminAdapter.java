...
import ducthuan.com.lamdep.Activity.ChiTietDonHangAdminActivity;
...
public class QuanLyDonHangAdminAdapter extends RecyclerView.Adapter<QuanLyDonHangAdminAdapter.ViewHolder>{

    Context context;
    ArrayList<QuanLyDonHangShop>quanLyDonHangShops;
    ArrayList<String>madhs;

    public QuanLyDonHangAdminAdapter(Context context, ArrayList<QuanLyDonHangShop> quanLyDonHangShops, ArrayList<String>madhs) {
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    Intent intent = new Intent(context, ChiTietDonHangAdminActivity.class);
