...
import ducthuan.com.lamdep.Activity.AdminXacNhanSanPhamActivity;
...
public class SanPhamChoXacNhanAdapter extends RecyclerView.Adapter<SanPhamChoXacNhanAdapter.ViewHolder> {

    Context context;
    ArrayList<SanPham> sanPhams;

    public SanPhamChoXacNhanAdapter(Context context, ArrayList<SanPham> sanPhams) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, AdminXacNhanSanPhamActivity.class);
